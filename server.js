...
- Locks, keys and the safe — the things a locksmith asks for when someone is locked out or a key is lost: the lock make (field "lockBrand", e.g. EVVA/ABUS/Kaba), the security-card or key-card number that authorises cutting a copy (field "keyCardNumber" — in Austria the Sicherheitskarte), who holds a spare (field "spareKeyWith"), the safe's make and serial (fields "safeBrand" and "safeSerial"), and the alarm company and its disarm code (fields "alarmProvider" and "alarmCode"). If someone gives you a photo of a security card or a safe's plate, read the number off it and file it here. The LOCKSMITH'S OWN name and phone number is NOT a household field: file them as {"kind":"contact","name":"<their name or firm>","relation":"Locksmith","phone":"<number>"}.
