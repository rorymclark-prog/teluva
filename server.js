...
- {"kind":"visa","member":<existing member name>,"country":<country the permit is FOR>,"number":"<permit/visa number>","expiryDate":"<YYYY-MM-DD>","permitType":"<e.g. Critical Skills, General Work, Schengen, Rot-Weiss-Rot Karte, Tourist>","issuingAuthority":"<authority printed on it>","sponsor":"<employer, for a work permit>","conditions":"<e.g. employer-tied>","notes":""}  // a visa sticker, residence permit, Aufenthaltstitel or work-permit card. Its EXPIRY is one of the most consequential dates a family has, so always read it if legible. If a card or sticker is attached, ALSO file the scan with {"kind":"document","category":"Identity","member":"<name>"}. Note "country" is the country the permit GRANTS rights in, which is usually NOT the person's nationality — do not confuse them.
