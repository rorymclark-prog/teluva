...
export default function ImportantInfo({ isBusinessSpace, refreshKey, onContactsChange }: ImportantInfoProps) {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {/* Rendered in BOTH space types on purpose. The business-milestones agent
          wrapped this in `!isBusinessSpace`, but the advisor-contacts work
          deliberately widened this directory beyond doctors to accountants,
          lawyers and financial advisers — professionals a BUSINESS keeps on file
          more than a family does. ProvidersSection re-labels itself via
          isBusinessSpace rather than disappearing. */}
      <ProvidersSection
        entries={providers}
