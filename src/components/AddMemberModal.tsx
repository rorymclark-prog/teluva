...
import { X, UserPlus, Sparkles, Camera, Upload, RefreshCcw, Image as ImageIcon } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 shadow-xl border border-slate-150"
          >
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 font-sans tracking-tight">Add Family Member</h3>
                  <p className="text-xs text-slate-500">Create a profile for clothes sizes, passports, and secure files.</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-sm placeholder:text-slate-400"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-sm"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-sm text-slate-800"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2.5">
                  ...
                  <div className="p-4 bg-slate-50 border border-slate-150 rounded-xl space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="inline-flex items-center gap-1 px-3 py-1.5 bg-indigo-55 text-indigo-700 hover:bg-indigo-100/80 rounded-lg text-[10px] font-bold uppercase tracking-wider cursor-pointer transition-all border border-indigo-200">
                ...
                {avatarMode === 'camera' && (
                  <div className="p-4 bg-slate-50 border border-slate-150 rounded-xl space-y-3">
                    {isCameraActive ? (
                      <div className="space-y-2.5">
                        <div className="aspect-square w-full max-w-[220px] mx-auto rounded-xl overflow-hidden bg-black border border-slate-250 relative">
                          <video
                            ref={videoRef}
                            autoPlay
                            playsInline
                        ...
                        <div className="flex justify-center">
                          <button
                            ...
                            className="px-4 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-[10px] font-bold uppercase tracking-wider shadow-sm transition-all cursor-pointer flex items-center gap-1"
                          >
                      ...
                      <div className="text-center py-4 bg-slate-100 border border-dashed border-slate-200 rounded-lg">
                        {cameraError ? (
                          <div className="space-y-2 px-3">
                            ...
                            >
                              <RefreshCcw className="w-3 h-3 animate-spin duration-1000" /> Retry Camera
                            </button>
                          </div>
                        ) : (
