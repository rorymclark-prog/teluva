...
import { STEPS, type TourCtx, type TourStepDef } from './firstRunSteps';

export type { TourCtx } from './firstRunSteps';
...
export default function FirstRunTour({
  ...
  // keepChrome: the tour SPOTLIGHTS the assistant launcher and the section
  // menu. Marking a modal layer here would hide the very controls it is
  // pointing at, leaving a highlight ring around empty screen.
  useBodyScrollLock(status === 'active', { keepChrome: true });
